...
@section("title"){{ "Aktualizacja grupy" }}@endsection
@section("breadcrumbs")
    <li class="breadcrumb-item" aria-current="page"><a href="{{ route("office.permissions") }}">{{ __("Grupy uprawnień") }}</a></li>
    <li class="breadcrumb-item active" aria-current="page">{{ __("Aktualizacja grupy") }}</li>
@endsection
...
@section("content")
    ...
    <form method="POST" action="{{ route("office.permission.update.post", $id) }}" class="validate">
